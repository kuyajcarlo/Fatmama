...
export default function Chatbot() {
  ...
  >
    ...
    /* Chat Window */
      ...
      {isOpen && <div className="fixed bottom-6 right-6 w-[380px] h-[600px] bg-white rounded-lg shadow-2xl flex flex-col z-50 border border-gray-200">
          {
    /* Header */
  }
  ...
  >
                <div
    className={`max-w-[80%] p-3 rounded-lg ${message.sender === "user" ? "bg-[#D4A843] text-white" : "bg-white text-gray-800 border border-gray-200"}`}
  >
    ...
    /* Quick Questions */
          ...
          {messages.length <= 1 && <div className="p-4 border-t bg-white">
