...
import { ShoppingCart, User, Menu, X, ChevronDown, LogIn, UserPlus, LogOut, LayoutDashboard, Package } from "lucide-react";
...
export default function Layout() {
  ...
  >
                ...
                {menuDropdownOpen && <div className="absolute top-full left-0 mt-2 bg-white shadow-lg rounded-md py-2 min-w-[200px] border-2 border-[#D4A843]">
                    <Link
